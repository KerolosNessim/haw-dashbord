...
import { useBlogCategoryDetail } from "@/features/blog-categories/hooks/useBlogCategoryDetail";
...
export default function EditBlogCategoryPage() {
  ...
  const { data: initialValues, isLoading, isError } = useBlogCategoryDetail(id);
