...
import { AlignLeft, Loader2, Plus, Save, ShieldCheck, Type, X } from "lucide-react";
...
/**
 * Validation schema for the Dependencies section
 */
 ...
 *
 * Manages the Accreditations section with a title, description, and multi-image gallery.
 */
export default function DependenciesTab() {
  const { t } = useTranslation("translation", { keyPrefix: "home_content.dependencies" });
  ...
  // Track actual File objects for new uploads (separate from the preview URL strings)
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    files.forEach((file) => {
      ...
      reader.onloadend = () => {
        ...
        setValue("images", [...watch("images"), result], { shouldValidate: true });
      };
