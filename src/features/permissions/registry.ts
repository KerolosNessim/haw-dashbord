...
export const PERMISSION_BY_ROUTE: Record<string, string> = {
  ...
  "/ai-services": p("services", "view"),
  "/ai-services/create": p("services", "create"),
...
export const DASHBOARD_PERMISSION_RESOURCES: readonly PermissionResourceDef[] = [
  ...
  { resource: "redirects", actions: ["view", "create", "update", "delete"], labelKey: "redirects", group: "content" },
  ...
  { resource: "authors", actions: ["view", "create", "update", "delete"], labelKey: "author", group: "content" },
  { resource: "jobs-header", actions: ["view", "update"], labelKey: "jobs_header", group: "content" },
  { resource: "jobs-sections", actions: ["view", "create", "update", "delete"], labelKey: "jobs_sections", group: "content" },
  { resource: "jobs-openings", actions: ["view", "create", "update", "delete"], labelKey: "jobs_openings", group: "content" },
  { resource: "jobs-applications", actions: ["view", "delete"], labelKey: "jobs_applications", group: "crm" },
  { resource: "legal", actions: ["view", "update"], labelKey: "legal", group: "content" },
  { resource: "contact-headers", actions: ["view", "create", "update", "delete"], labelKey: "contact_headers", group: "content" },
