      ...
      <Table>
        <TableHeader className="bg-muted/30">
          <TableRow className="hover:bg-transparent border-none">
            ...
            <TableHead className="font-bold text-foreground">{t("blogs_count")}</TableHead>
            <TableHead className="font-bold text-foreground">{t("status")}</TableHead>
            <TableHead className="py-6 px-8 font-bold text-foreground w-[200px]">{t("actions")}</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {categories.map((cat) => (
