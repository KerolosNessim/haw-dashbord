    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          /* LTR: off = start (left), on = end (right) */
          ...
          /* RTL: off = start (right), on = end (left) — skipped when `dir="ltr"` is set on the root */
          "rtl:group-data-[size=default]/switch:data-unchecked:translate-x-[calc(100%-2px)] rtl:group-data-[size=sm]/switch:data-unchecked:translate-x-[calc(100%-2px)]",
          "rtl:group-data-[size=default]/switch:data-checked:translate-x-0 rtl:group-data-[size=sm]/switch:data-checked:translate-x-0",
        )}
      />
    </SwitchPrimitive.Root>
  )
